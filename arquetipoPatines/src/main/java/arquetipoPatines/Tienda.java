...
import arquetipoPatines.Patinete.Estado;

public class Tienda {
	//objeto array de patinetes
    ...
    public int getNumeroPatinetes() {
    	//Se obtiene el número patinentes con el tamaño del array de Patinete
        int nPatinetes;
        try {
...
//Para la compra de patinetes, el numero de patinentes(cuantos) debe ser mayor a 0 y se almacena en la variable nPatinentesHay
    //
